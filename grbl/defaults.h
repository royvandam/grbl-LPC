...
#pragma once
  ...
  #define DEFAULT_X_MAX_TRAVEL   1950.0             // $130 mm (X max travel; must be positive)
  #define DEFAULT_Y_MAX_TRAVEL   2700.0             // $131 mm (Y max travel; must be positive)
  #define DEFAULT_Z_MAX_TRAVEL   100.0              // $132 mm (Z max travel; must be positive)
